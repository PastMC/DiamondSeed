...
public class Ore {
    private static final boolean coal = false;
    private static final boolean iron = false;
    private static final boolean gold = false;
    private static final boolean redstone = false;
    private static final boolean diamond = true;
    private static final boolean lapis = false;
    private static final boolean copper = false;
    private static final boolean emerald = false;
    private static final boolean quartz = false;
    private static final boolean debris = true;
    public Type type;
